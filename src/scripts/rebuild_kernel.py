...
parser.add_argument("-l",  "--lval",   type=int,    required=True,              help="l-value of kernels to rebuild.")
...
#    kernel_file = open("kernel"+str(soapl)+"_nconf"+str(nstruct)+"_sigma"+str(sg)+"_lcut"+str(lcut)+"_cutoff"+str(rcut)+"_cweight"+str(cw)+".txt","w")
    kernel_file = open("kernel"+str(soapl)+"_nconf"+str(nstruct)+"_sigma"+str(sg)+"_lcut"+str(lcut)+"_cutoff"+str(rcut)+"_cweight"+str(cw)+".npy","wb")
else:
#    kernel_file = open("kernel"+str(soapl)+"_atom"+str(atom_type)+"_nconf"+str(nstruct)+"_sigma"+str(sg)+"_lcut"+str(lcut)+"_cutoff"+str(rcut)+"_cweight"+str(cw)+".txt","w")
    kernel_file = open("kernel"+str(soapl)+"_atom"+str(atom_type)+"_nconf"+str(nstruct)+"_sigma"+str(sg)+"_lcut"+str(lcut)+"_cutoff"+str(rcut)+"_cweight"+str(cw)+".npy","wb")
